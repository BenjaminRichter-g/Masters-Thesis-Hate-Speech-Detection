...
def is_discriminatory(text: str) -> bool:
    ...
    Assumes binary classification: 1 = discriminatory, 0 = non-discriminatory.
    """
    try:
...
def classify_with_confidence(model, text: str, conf):
    """
...
if __name__ == '__main__':
    ...
    for i, model_path in enumerate(model_paths):
        ...
        values = classification_filter(args.input, output_paths[i][0],output_paths[i][1], model, classify_with_confidence, confidence=0.9)
        values = list(values)
